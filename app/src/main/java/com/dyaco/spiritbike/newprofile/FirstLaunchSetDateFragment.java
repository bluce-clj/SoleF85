...
public class FirstLaunchSetDateFragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_first_launch_set_date, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        Button btBack_SetDate = view.findViewById(R.id.btBack_SetDate);
        btBack_SetDate.setOnClickListener(view12 -> Navigation.findNavController(view12).navigate(R.id.action_firstLaunchSetDateFragment_to_firstLaunchWifiWidgetFragment));
        Button btNext_SetDate = view.findViewById(R.id.btNext_SetDate);
        btNext_SetDate.setOnClickListener(view1 -> Navigation.findNavController(view1).navigate(R.id.action_firstLaunchSetDateFragment_to_firstLaunchSetTimeFragment));
    ...
    private void initDate() {
        ...
        Log.d("AAAAAA", "year: " + targetYear + ", month: " + targetMonth + ", day: " + targetDay);
    }
