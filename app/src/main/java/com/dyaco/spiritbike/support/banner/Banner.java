package com.dyaco.spiritbike.support.banner;
...
import com.dyaco.spiritbike.support.banner.config.BannerConfig;
import com.dyaco.spiritbike.support.banner.config.IndicatorConfig;
import com.dyaco.spiritbike.support.banner.indicator.Indicator;
import com.dyaco.spiritbike.support.banner.listener.OnBannerListener;
import com.dyaco.spiritbike.support.banner.listener.OnPageChangeListener;
import com.dyaco.spiritbike.support.banner.transformer.ScaleInTransformer;
import com.dyaco.spiritbike.support.banner.util.BannerLifecycleObserver;
import com.dyaco.spiritbike.support.banner.util.BannerLifecycleObserverAdapter;
import com.dyaco.spiritbike.support.banner.util.BannerUtils;
import com.dyaco.spiritbike.support.banner.util.LogUtils;
import com.dyaco.spiritbike.support.banner.util.ScrollSpeedManger;
...
public class Banner<T, BA extends BannerAdapter> extends FrameLayout implements BannerLifecycleObserver {
    ...
    private int selectedHeight = BannerConfig.INDICATOR_SELECTED_HEIGHT;
    ...
    public Banner setIndicatorSelectedHeight(int selectedHeight) {
        if (mIndicator != null) {
            mIndicator.getIndicatorConfig().setSelectedHeight(selectedHeight);
        }
        return this;
    }
