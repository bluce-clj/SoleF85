package com.dyaco.spiritbike.support.banner.util;
...
public class ScrollSpeedManger extends LinearLayoutManager {
    ...
    public static void reflectLayoutManager(Banner banner) {
        ...
        try {
            ...
            ScrollSpeedManger speedManger = new ScrollSpeedManger(banner, (LinearLayoutManager) Objects.requireNonNull(recyclerView.getLayoutManager()));
